...
Muse is a Flutter app for music practice. It brings together the small tools that are useful during a practice session: a metronome, a microphone-based tuner, and an audio-track workspace for listening back and transcribing material.

The project is currently a work in progress. The core feature flows and local persistence are in place; the interface and several important practice-focused capabilities are still being developed.
...
- Adjustable tempo from 0 to 300 BPM.
- Play/pause control.
- A four-beat visual counter driven by a Flutter ticker.
...
Muse is an active prototype. Contributions and experiments should prioritize reliable audio behavior, clear feedback, and workflows that make daily practice easier.
